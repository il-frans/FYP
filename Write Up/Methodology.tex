...
\section{Summary}
This chapter started by the goals for this research. Further on the experiment design in which the questionnaires, user study with control and feedback groups and the sessions have been thoroughly  discussed. Further more possible hardware and software solutions were discussed, concluding by choosing the G25 and Assetto Corsa. The chapters ends by discussing the evaluation aspect of the project in which statistical test such as the Mann-Whitney U Test and Independent T Test are to be used. The next chapter will draw on this chapter and go in detail on how the methods discussed here have been implemented.